...
- **Trusted sources only:** every item — news and fun fact — must link to an established, reputable outlet and, where possible, be corroborated by a second one. Good: major wire services and newspapers (Reuters, AP, AFP, Bloomberg, WSJ, NYT, Washington Post, The Guardian, Financial Times), major broadcasters (BBC, NPR, PBS, CNN, ABC/NBC/CBS News, Al Jazeera), and respected domain outlets (Nature, Science, ScienceDaily citing a named journal, AP/Reuters science desks, SEC/central-bank/agency statements, TechCrunch, The Verge, Ars Technica). **Do not use** content farms, SEO/listicle blogs, AI-generated news sites, press releases dressed as reporting, single-source social media posts, or fringe/partisan advocacy sites. If a story only shows up on low-quality sources, drop it and use the next one. When outlets conflict on a fact, go with the wire-service version.
